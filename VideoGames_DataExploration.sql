...
--2. How many games in the game_sales table are missing both a user_score and a critic_score? 
...
--3. Looking at the years with the highest average critic_score.
...
--4. Find game critics' ten favorite years, where a year must have more than 4 games released
...
--5. Looking at the years that dropped off the critics' favorite list. (They were on the
...
--6. Looking at the years that are present on both critics' lists. 
...
--7. Looking at the 10 highest average_user_score values. 
...
--8. Looking at years that appeared on both the critics' favorites list and users' favorites list
...
--9. Looking at sales in the best video game years.
